...
[Defines]
  PLATFORM_NAME                  = P3450
  PLATFORM_GUID                  = 2fd74ba8-52fb-47b7-9968-c4ee4d9b7564
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/P3450-$(ARCH)
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = P3450Pkg/P3450.fdf
...
[LibraryClasses.common]
  ...
  ArmPlatformLib|P3450Pkg/Library/P3450PlatformLib/P3450PlatformLib.inf
  PlatformBootManagerLib|P3450Pkg/Library/PlatformBootManagerLib/PlatformBootManagerLib.inf
...
[PcdsFixedAtBuild.common]
  ...
  gEfiMdeModulePkgTokenSpaceGuid.PcdFirmwareVendor|L"Mr Tunnel"
  # According to TRM
